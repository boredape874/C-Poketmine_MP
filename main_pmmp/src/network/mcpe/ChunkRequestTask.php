...
class ChunkRequestTask extends AsyncTask{
	...
	public function onRun() : void{
		...
		$packetStream = new ByteBufferWriter();
		LevelChunkPacket::create(new ChunkPosition($this->chunkX, $this->chunkZ), $dimensionId, $subCount, false, null, $payload)->encode($packetStream);
		$packetBuffer = $packetStream->getData();

		$stream = new ByteBufferWriter();
		PacketBatch::encodeRawSingle($stream, $packetBuffer, strlen($packetBuffer));
