...
class BedrockWorldData extends BaseNbtWorldData{
	...
	public static function generate(string $path, string $name, WorldCreationOptions $options) : void{
		...
		$worldData = CompoundTag::create()
			...
			->setTag(self::TAG_LAST_OPENED_WITH_VERSION, self::makeLastOpenedWithVersionTag())
	...
	public function save() : void{
		...
		$this->compoundTag->setTag(self::TAG_LAST_OPENED_WITH_VERSION, self::makeLastOpenedWithVersionTag());
	...
	private static function makeLastOpenedWithVersionTag() : ListTag{
		$tags = [];
		foreach(self::CURRENT_CLIENT_VERSION_TARGET as $versionPart){
			$tags[] = new IntTag($versionPart);
		}
