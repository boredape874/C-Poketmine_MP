...
class Chunk{
	...
	public function __clone(){
		...
		/** @phpstan-var \SplFixedArray<SubChunk> $subChunks */
		$subChunks = new \SplFixedArray($this->subChunks->getSize());
		foreach($this->subChunks as $index => $subChunk){
			$subChunks[$index] = $subChunk !== null ? clone $subChunk : new SubChunk(Block::EMPTY_STATE_ID, [], new PalettedBlockArray(BiomeIds::OCEAN));
		}
